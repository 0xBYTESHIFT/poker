...
int main(int argc, char* argv[]) {
    ...
    }
    {
        ...
        const auto log_rsp = api::from_json<api::login_response>(rsp.text);
    ...
    for (size_t i = 0; i < count; i++) {
        std::string room_token;
        {
            ...
            req.pass_hash = pass;
            const auto rsp = send(remote, req.to_json());
            const auto room_rsp = api::new_room_response::from_json(rsp.text);
        ...
        }
        {
            ...
            const auto rsp = send(remote, req.to_json());
            const auto room_rsp = api::enter_room_response::from_json(rsp.text);
        ...
        }
        {
            ...
            req.room_token = room_token;
            const auto rsp = send(remote, req.to_json());
            const auto room_rsp = api::leave_room_response::from_json(rsp.text);
        ...
        }
        {
            ...
            req.room_token = room_token;
            const auto rsp = send(remote, req.to_json());
            const auto room_rsp = api::del_room_response::from_json(rsp.text);
    ...
    }
    {
        ...
        req.pass_hash = pass;
        const auto rsp = send(remote, req.to_json());
        const auto unreg_rsp = api::unregister_response::from_json(rsp.text);
    ...
    }
    {
        ...
        req.token = token;
        const auto rsp = send(remote, req.to_json());
        const auto unlog_rsp = api::unlogin_response::from_json(rsp.text);
