...
namespace api {
    ...
    struct unlogin_request {
        ...
        static auto from_json(const json& j) -> unlogin_request;
    ...
    struct unlogin_response {
        ...
        static auto from_json(const json& j) -> unlogin_response;
        auto to_json() const -> json;
    };

    inline auto unlogin_request::from_json(const json& j) -> unlogin_request {
        ZoneScoped;
        unlogin_request req;
    ...
    inline auto unlogin_request::to_json() const -> json {
        ZoneScoped;
        json j;
    ...
    inline auto unlogin_response::from_json(const json& j) -> unlogin_response {
        ZoneScoped;
    ...
    inline auto unlogin_response::to_json() const -> json {
        ZoneScoped;
        json j;
        write_to_json(j, type);
