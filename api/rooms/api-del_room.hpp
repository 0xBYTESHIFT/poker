...
namespace api {
    ...
    struct del_room_request {
        ...
        static auto from_json(const json_t& j) -> del_room_request;
    ...
    struct del_room_response {
        ...
        static auto from_json(const json_t& j) -> del_room_response;
        auto to_json() const -> json_t;
    };

    inline auto del_room_request::from_json(const json_t& j) -> del_room_request {
        ZoneScoped;
    ...
    inline auto del_room_request::to_json() const -> json_t{
        ZoneScoped;
        json_t j;
    ...
    /*==============================================================*/
    inline auto del_room_response::from_json(const json_t& j) -> del_room_response {
        ZoneScoped;
    ...
    inline auto del_room_response::to_json() const -> json_t{
        ZoneScoped;
        json_t j;
        write_to_json(j, this->type);
