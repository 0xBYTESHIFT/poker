...
namespace api {
    ...
    struct enter_room_request {
        ...
        static auto from_json(const json& j) -> enter_room_request;
    ...
    struct enter_room_response {
        ...
        static auto from_json(const json& j) -> enter_room_response;
        auto to_json() const -> json;
    };

    inline auto enter_room_request::from_json(const json& j) -> enter_room_request {
        ZoneScoped;
    ...
    inline auto enter_room_request::to_json() const -> json {
        ZoneScoped;
        json j;
    ...
    inline auto enter_room_response::from_json(const json& j) -> enter_room_response {
        ZoneScoped;
    ...
    inline auto enter_room_response::to_json() const -> json {
        ZoneScoped;
        json j;
        write_to_json(j, this->type);
