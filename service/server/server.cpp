...
auto server::handle_request(ge::actor_address sender, session_id id, json& j_) -> void {
    ...
    if (type == api::register_request::type()()) {
        ...
        auto req = api::login_request::from_json(j.dump());
        senders_[id] = sender;
